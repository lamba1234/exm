...
$sql = "SELECT employee_id, first_name, last_name FROM employees WHERE company_id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $company_id);
$stmt->execute();
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg mb-6">
                <div class="px-4 py-5 sm:p-6">
                    <h2 class="text-2xl font-bold text-gray-900">View All Expenses</h2>
                    <p class="mt-1 text-gray-600">View and filter expenses for all employees in your company</p>
                </div>
            </div>
                ...
                <div class="px-4 py-5 sm:p-6">
                    <form method="GET" class="space-y-4">
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="admin_view_expenses.php" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                Clear Filters
                            </a>
